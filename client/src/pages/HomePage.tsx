            ...
            <div className="w-full space-y-24 lg:space-y-32 justify-items-center">
                ...
                <div className="text-center max-w-6xl mx-auto">
                    ...
                    <p className="text-xl sm:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
                        Send sensitive information that can only be read once
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
                    <Card variant="cyan">
                        ...
                        <p className="text-gray-300 leading-relaxed text-lg">
                            Your secret can only be viewed once. After that,
                    ...
                    <Card variant="emerald">
                        ...
                        <p className="text-gray-300 leading-relaxed text-lg">
                            Optionally add password protection for an extra
                            layer of security.
                        </p>
                    </Card>
                    ...
                    >
                        ...
                        <p className="text-gray-300 leading-relaxed text-lg">
                            Attach up to 3 files to your secret message for
                            secure sharing.
                        </p>
                    </Card>
                </div>
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16">
                        <div className="text-center">
                            <IconBox
                                ...
                                size="lg"
                                shape="circle"
                                className="mx-auto mb-8 border-4 border-cyan-400/30"
                            >
                                <span className="text-white font-black text-5xl sm:text-6xl">
                                    1
                                </span>
                            </IconBox>
                        ...
                        <div className="text-center">
                            <IconBox
                                ...
                                size="lg"
                                shape="circle"
                                className="mx-auto mb-8 border-4 border-emerald-400/30"
                            >
                                <span className="text-white font-black text-5xl sm:text-6xl">
                                    2
                                </span>
